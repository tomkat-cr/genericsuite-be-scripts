...
PIPENV_ARGS="APP_STAGE=$APP_STAGE MCP_SERVER_PORT=$MCP_SERVER_PORT MCP_SERVER_HOST=$MCP_SERVER_HOST MCP_TRANSPORT=$MCP_TRANSPORT APP_DB_ENGINE=$APP_DB_ENGINE APP_DB_NAME=$APP_DB_NAME APP_DB_URI=\"$APP_DB_URI\" APP_CORS_ORIGIN=\"$APP_CORS_ORIGIN\" AWS_S3_CHATBOT_ATTACHMENTS_BUCKET=\"$AWS_S3_CHATBOT_ATTACHMENTS_BUCKET\" APP_HOST_NAME=$APP_HOST_NAME CURRENT_FRAMEWORK=$CURRENT_FRAMEWORK CLOUD_PROVIDER=$CLOUD_PROVIDER"
